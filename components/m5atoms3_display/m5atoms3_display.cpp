...
static const char *const TAG = "m5atoms3.display";
...
float M5AtomS3Display::get_setup_priority() const { return setup_priority::HARDWARE; }
void M5AtomS3Display::dump_config() {}
int M5AtomS3Display::get_width_internal() { return M5.Display.width(); }
int M5AtomS3Display::get_height_internal() { return M5.Display.height(); }


void M5AtomS3Display::draw_pixel_at(int x, int y, Color color) {
...
void M5AtomS3Display::fill(Color color) {
